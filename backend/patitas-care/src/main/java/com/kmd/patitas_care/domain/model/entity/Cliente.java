...
public class Cliente extends Usuario {
    ...
    protected Cliente(String id, String nombre, String correo, String passwordHash, TipoDeUsuario tipo,
    ...
    public static class ClienteBuilder extends UsuarioBuilder<ClienteBuilder> {
        ...
        public Cliente build(){
            ...
            return new Cliente(id, nombre, correo, passwordHash, tipo, mascotas, citas, notificaciones, mensajes);
        }
    }
}
